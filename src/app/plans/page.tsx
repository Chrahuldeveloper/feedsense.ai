  ...
  return (
    <div className="bg-[#000000] w-full min-h-screen overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col md:flex-row gap-8 px-6 md:px-10 pb-14 justify-center -mt-36">
          {Plans.map((plan, idx) => (
            <div
              key={idx}
            ...
            >
              <div className="bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 p-6 space-y-4 rounded-t-lg text-center">
                <h1 className="text-white text-2xl font-bold">{plan.name}</h1>
                <p className="text-lg font-semibold text-slate-200">{plan.price}</p>
              </div>
              ...
              <div className="p-6 mt-auto">
                <Link href={`/subscription/${plan.name}`}>
                  <button className="w-full bg-gradient-to-r from-blue-400 via-blue-600 to-blue-700 mt-4 text-white py-3 font-semibold rounded-full shadow-md hover:shadow-lg transition-shadow duration-200">
                    Get Plan
                  </button>
                </Link>
              </div>
